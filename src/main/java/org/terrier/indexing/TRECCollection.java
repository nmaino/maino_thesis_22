...
public class TRECCollection extends MultiDocumentFileCollection {
	...
	*/
	...
	/**I added this method because I like using lists when I'm making tests for the indexing phase.
	 * (and for consistency with the {@link SimpleFileCollection} class, which 
	 * has such builder while the TRECCollection didn't).
	 * 
	 * @author Dennis Dosso
	 * */
